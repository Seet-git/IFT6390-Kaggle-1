...
def load_data():
    ...
    vocab_map = np.load('vocab_map.npy', allow_pickle=True).item()
...
def build_and_train_model(X_train, y_train, X_val, y_val):
    ...
    history = model.fit(X_train, y_train, validation_data=(X_val, y_val), epochs=20, batch_size=32, verbose=1, class_weight=class_weight_dict)
